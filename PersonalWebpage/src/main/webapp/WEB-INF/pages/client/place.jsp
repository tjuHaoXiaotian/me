      ...
      <div class="row">
        <div class="col s12">
          <div class="card" style="padding:30px;">
            <form action="<%=request.getContextPath()%>/mng/applys/add?type=3" method="post">
              <div class="row">
                <div class="input-field col s3">
                  <input id="place" name="targetName" type="text" class="validate">
                  <label for="weeks">输入申请场地</label>
                </div>
              </div>
              <div class="row">
                <div class="input-field col s3">
