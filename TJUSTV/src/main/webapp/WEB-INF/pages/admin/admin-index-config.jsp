...
<div class="admin-content" style="height: 100%">
  <div class="admin-content-body">
    <div class="am-cf am-padding">
      <div id="video_lists" class="am-fl am-cf"><strong class="am-text-primary am-text-lg">视频管理</strong> / <small>首页列表</small></div>
    </div>
...
<script>
  ...
  function getUrl(){
      return rootUrl + "${pageContext.request.contextPath}/videos/index";
  }
  var table;
  function loadTable(){
    $.ajax({
      ...
      table = $('#videos').DataTable({
        ...
        "columnDefs": [
          ...
          },
          {
            "targets": -2,
            "render": function (data, type, row, table) {
              return '<a onclick="unSetIndex('+data+')" class="am-btn am-btn-default am-btn-xs"> <span class="am-icon-play am-text-success">取消首页</span></a>';
            }
          },
          {
            "targets": -1,
...
//             data:JSON.stringify(newApply)
  ...
  function unSetIndex(id){
    $.ajax({
      url: rootUrl+'${pageContext.request.contextPath}/videos/'+id+'/unSetIndex',
      type: 'get',
      dataType: 'json'
    }).success(function(data){
      loadTable();
