...
<head lang="en">
  ...
  <title>登录</title>
  <meta name="description" content="tjusau login">
  <meta name="keywords" content="index">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="renderer" content="webkit">
  <meta http-equiv="Cache-Control" content="no-siteapp" />
  <link rel="icon" type="image/png" href="<%=request.getContextPath()%>/resources/img/logo.jpg">
  <link rel="apple-touch-icon-precomposed" href="<%=request.getContextPath()%>/resources/img/logo.jpg">
...
<div class="am-g">
  <div class="am-u-lg-6 am-u-md-8 am-u-sm-centered">
    ...
    <form action="${pageContext.request.contextPath}/admin/login" method="post" class="am-form">
