    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">我的文章</strong> / <small>添加文章</small></div>
            </div>
            <hr>
            <div class="am-g ">
                    ...
                    <div class="am-tabs-bd">
                        ...
                        <form class="am-form">
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-5">
                                    <select id="newsTypes" class="am-input-sm">

                                    </select>
                                </div>
                                <div class="am-u-sm-12 am-u-md-5">*必填</div>
                            </div>
                            ...
                            <div class="am-g am-margin-top">
                                ...
                                <div class="am-u-sm-8 am-u-md-5">
                                    <button onclick="addNews()" class="am-btn am-btn-primary am-btn-block" >提交</button>
                                </div>
                                <div class="am-hide-sm-only am-u-md-5"></div>
                            </div>
...
//    }
    ...
    function getTypes(){
        $.ajax({
            url: rootUrl + "/newsTypes",
            contentType:"application/json",
            type: 'get',
            dataType:'JSON'
        }).success(function(data){
            if(data.state == 200){
                var types = data.data.newsTypes;
                var html = "";
                for(var i = 0; i < types.length; i++){
                    html += '<option value="'+types[i].id+'">'+types[i].classDescription+'</option>';
                }
                $("#newsTypes").html(html);
            }else{
              alert("types 获取失败！");
