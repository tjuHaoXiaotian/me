...
<div class="header am-topbar ">
    <div class="am-g">
        <h1><span class="am-icon-youtube-play am-icon-sm">&nbsp;&nbsp;TJUSAU</span></h1>
    </div>
...
<div class="am-g">
    <div class="body am-u-lg-6 am-u-md-8 am-u-sm-centered">
        ...
        <shiro:user>
            ...
            <a href="${pageContext.request.contextPath}/users" target="_blank">用户管理</a><br/>
        </shiro:user>

        <h1 style="text-align: center"> TJU SAU</h1>
